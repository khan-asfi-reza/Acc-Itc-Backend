...
class UserAdminCreationForm(forms.ModelForm):
    ...
    country_code = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Country Code'}),
                                   label="Phone number Country Code", required=True)
    ...
    class Meta:
        model = User
        fields = ('username', 'name', 'phone_number', 'country_code', 'email',)
...
class UserAdminChangeForm(UserChangeForm):
    ...
    class Meta:
        model = User
        fields = ('username', 'phone_number', 'country_code', 'name', 'email', 'active', 'admin',)
...
class AdminCreationForm(UserAdminCreationForm):
    ...
    class Meta:
        model = User
        fields = ('username', 'phone_number', 'email', 'name', 'admin', 'staff')
